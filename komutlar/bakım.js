...
exports.run = async (client, message, args) => {
  if (message.author.id !== "714451348212678658j")
    return message.channel.send("Bu komutu sadece sahibim kullanabilir :x:");
  ...
  if (args[0] === "açık") {
    ...
    codemings = "Thetis";
    if (!codeming)
      return message.channel.send(":x: Bir bakım sebebi girmelisin.");
