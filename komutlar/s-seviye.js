...
exports.run = async (client, message, args) => {
  const aktifdegil = new Discord.RichEmbed()
  .setColor("RED")
  .setTitle("HATA")
  .setDescription("Seviye sistemi aktif değil\nAçmak için " + prefix + "yardım seviye")
 .setFooter("Thetis Seviye Sistemi")
  ...
  if (!hm)
    return message.channel.send(aktifdegil);
