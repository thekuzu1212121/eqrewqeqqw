...
exports.run = async (client, message) => {
  ...
  message.channel
    .send(
      `**Çekilişin yapılacağı kanalın adını yaz**\n Lütfen bu mesajdan sonra odayı etiketlemeden yazın!`
    )
    .then(msg => {
      message.channel
        ...
        .then(collected => {
          ...
          if (!room)
            return message.channel.send(
              "**Böyle bir kanal bulamadım lütfen tam bir şekilde etiket atmadan yazınız**"
            );
          room = collected.first().content;
          collected.first().delete();
          msg
            .edit(
              "**Çekilişin süresini belirle (1s (saniye) 1s-59s, 1m (dakika) 1m-59m, 1h (saat) 1h-59h, 1d (gün) 1d-6d, 1w (hafta) Örnek: 3h**"
            )
            .then(msg => {
              message.channel
                .awaitMessages(filter, {
                      ...
                      .then(collected => {
                        ...
                        try {
                          let giveEmbed = new Discord.RichEmbed()
                            ...
                            .setFooter(
                              message.author.username + " Thetis Çekiliş ",
                          ...
                          message.guild.channels
                            ...
                            .then(m => {
                              ...
                              setTimeout(() => {
                                ...
                                let gFilter =
                                  list[
                                    Math.floor(Math.random() * list.length) + 0
                                  ];
